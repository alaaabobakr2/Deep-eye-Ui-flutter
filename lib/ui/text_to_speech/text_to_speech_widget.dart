...
class TextToSpeechWidget extends StatefulWidget {
  final lastDescription;

const  TextToSpeechWidget({super.key, required this.lastDescription} );
...
class _MyAppState extends State<TextToSpeechWidget> {
 ...
 // bool isCurrentLanguageInstalled = true;
  ...
  //   padding: EdgeInsets.only(top: 1.0, left: 25.0, right: 25.0),
  //   child: Text(widget.lastDescription!),
  //   // TextField(
  //   //   maxLines: 8,
  //   //   minLines: 3,
